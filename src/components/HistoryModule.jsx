 ...
 * HistoryModule
 *
 * Displays the complete archive of recorded attacks.
 * When a user selects an attack from the list, it displays ONLY that chosen attack's
 * threat vector on the 3D globe alongside its complete forensic analysis details.
 */
    ...
    <div className="history-module-container" style={{ 
      ...
      <div className="screen-header" style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
          ...
          {selectedHistory && <span style={{ fontSize: '14px', color: '#00ff41', opacity: 0.8, letterSpacing: '1px' }}>● SINGLE THREAT VECTOR VIEW</span>}
        </div>
      </div>
      ...
      <div className="history-content-wrapper" style={{ 
        ...
        {!selectedHistory ? (
          /* Full History Grid: view all recorded attacks */
            ...
            <div className="history-grid custom-scroll" style={{
              ...
              {historyList.map((item) => (
                <div 
                  key={item.id} 
                  onClick={() => {
                    console.log('%c[HISTORY_SELECT] Viewing single threat vector:', 'color: #ffaa00; font-weight: bold;', item);
          ...
          /* Selected Attack View: ONLY show the single selected threat vector and its details */
          <div className="split-layout" style={{ 
            ...
            {/* Globe: ONLY showing this single selected threat vector */}
            <div style={{ 
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <tbody>
                    {[
                      ...
                      ['THREAT_LEVEL (severity)', selectedHistory.severity || 'HIGH', '#ff0000'],
